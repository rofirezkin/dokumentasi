...
namespace WindowsFormsApp2
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WindowsFormsApp2.control.Resource1.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(WindowsFormsApp2.control.Resource1.AirSpeedNeedle);
