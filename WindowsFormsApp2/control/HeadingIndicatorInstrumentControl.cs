...
namespace WindowsFormsApp2
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WindowsFormsApp2.control.Resource1.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(WindowsFormsApp2.control.Resource1.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(WindowsFormsApp2.control.Resource1.HeadingIndicator_Aircraft);        
