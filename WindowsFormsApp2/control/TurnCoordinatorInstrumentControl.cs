...
namespace WindowsFormsApp2
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WindowsFormsApp2.control.Resource1.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(WindowsFormsApp2.control.Resource1.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(WindowsFormsApp2.control.Resource1.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(WindowsFormsApp2.control.Resource1.TurnCoordinatorMarks);
