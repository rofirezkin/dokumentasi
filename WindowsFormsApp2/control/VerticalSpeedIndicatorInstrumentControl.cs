...
namespace WindowsFormsApp2
{
    class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WindowsFormsApp2.control.Resource1.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(WindowsFormsApp2.control.Resource1.VerticalSpeedNeedle);
